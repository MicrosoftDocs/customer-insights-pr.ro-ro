---
title: Predicție retragere din tranzacții
...
> [!TIP]
> Încercați tutorialul pentru o churn de tranzacție predicție folosind exemple de date: [Ghid de eșantionare a tranzacției predicție (versiune preliminară)](sample-guide-predict-transactional-churn.md).
...
- (Opțional) Date despre clienții dvs.:
    - Aceste date ar trebui să fie rareori și ar trebui să se alinieze la atribute mai statice pentru a se asigura că modelul funcționează cel mai bine.
...
### <a name="provide-an-optional-list-of-benchmark-accounts-business-accounts-only"></a>Furnizați o listă opțională de conturi de referință (numai conturi de business)
