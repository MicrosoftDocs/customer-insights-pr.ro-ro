...
Administratorii pot configura Customer Insights pentru [utilizați unul existent Dataverse mediu inconjurator](create-environment.md) atunci când creează un mediu Customer Insights. Prin furnizarea URL-ului către Dataverse mediu, se atașează noului lor mediu Customer Insights. Informații despre clienți și Dataverse mediile trebuie să fie găzduite în aceeași regiune. 
