...
Vizualizați entitățile din [Navigator de entitate de model comun de date](https://microsoft.github.io/CDM/). Selectați o entitate din secțiunea Aplicație Insights pentru a obține lista entităților Customer Insights și definițiile acestora.

:::image type="content" source="media/CDM-entity-navigator.png" alt-text="Navigator entitate CDM care arată entitatea CustomerActivity.":::
